...
class ProfileController extends Controller {
    ...
    public function viewprofile(Request $request) {
        ...
        return view('admin.pages.profile.viewprofile',$data);
    }
    ...
    public function updateprofile(Request $request){
       // echo Auth::guard('admin')->user()->id;exit;
        ...
        return view('admin.pages.profile.updateprofile',$data);
    }
    ...
    public function changepassword(Request $request){
        ...
        return view('admin.pages.profile.changepassword',$data);
    }
    ...
    public function changeprofilepicture(Request $request){
        ...
        $data['profiledetails']=$profiledetails->getprofiledetails(Auth::guard('admin')->user()->id);
        $data['css'] = array(
        );        
        $data['js'] = array(
        );
        ...
        return view('admin.pages.profile.changeprofilepicture',$data);
    }
